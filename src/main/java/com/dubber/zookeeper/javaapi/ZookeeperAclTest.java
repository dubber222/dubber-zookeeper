...
public class ZookeeperAclTest implements Watcher {
    ...
    private final static String CONNECT_STRING
            = "192.168.0.110:2181,192.168.0.104:2181,192.168.0.106:2181";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            zookeeper = new ZooKeeper(CONNECT_STRING, 5000, new ZookeeperAclTest());
    ...
    public static void create(String path, Object value) throws Exception {
        //创建节点
        if (zookeeper.exists(path, new ZookeeperAclTest()) == null) {
            zookeeper.create(path, value.toString().getBytes(), ZooDefs.Ids.CREATOR_ALL_ACL, CreateMode.PERSISTENT);
    ...
    public static void createChildren(String zpath, Object value) throws Exception {
        if (zookeeper.exists(zpath, new ZookeeperAclTest()) == null) {
            //创建子节点
